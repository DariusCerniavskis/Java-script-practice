...
const squareObjects = document.getElementsByClassName("square");
...
const writeValueToBox = (fieldSize, maxFieldSize) => {
    ...
    for (let i = 0; i < maxFieldSize; i++) {
        ...
        for (let j = 0; j < maxFieldSize; j++) {
            ...
            currentBox.style.Height = boxSize;
...
console.log(squareObjects.length);

for (let i = 0; i < fieldSize; i++) {
    squareObjects[i].setAttribute("height", boxSize);
}

// squareObjects.forEach((el) => {
//     console.log(el);
//     el.setAttribute("height", boxSize);
//     // console.log("height before " + el.style.Height);
//     // el.style.Height = boxSize;
//     el.style.textContent = "10";
//     // console.log("height after " + el.style.Height);
// });
