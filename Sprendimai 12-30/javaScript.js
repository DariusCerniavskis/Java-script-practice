...
if (taskNumber == 1) {
    ...
    console.log(horsepowerSortedCars);
} else if (taskNumber == 2) {
    const maxHorsepowerCar = cars.reduce((acc, curr) => {
        return acc.Horsepower > curr.Horsepower ? acc : curr;
    });

    console.log("Car with max horsepower is:");
    console.log(maxHorsepowerCar);
} else if (taskNumber == 3) {
    const getMaxPowerCar = (getCars) => {
        const maxHorsepowerCar = getCars.reduce((acc, curr) => {
            return acc.Horsepower > curr.Horsepower ? acc : curr;
        });
